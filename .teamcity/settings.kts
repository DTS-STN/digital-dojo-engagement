...
project {
    vcsRoot(Dev_DigitalDojoEngagement_HttpsGithubComDtsStndigitalDojoEngagementRelease)
    vcsRoot(Dev_DigitalDojoEngagement_HttpsGithubComDtsStndigitalDojoEngagementDynamic)
...
object Dev_DigitalDojoEngagement_HttpsGithubComDtsStndigitalDojoEngagementRelease : GitVcsRoot({
    name = "https://github.com/DTS-STN/digital-dojo-engagement/tree/_release"
    url = "git@github.com:DTS-STN/digital-dojo-engagement.git"
...
object Dev_DigitalDojoEngagement_HttpsGithubComDtsStndigitalDojoEngagementDynamic : GitVcsRoot({
    name = "https://github.com/DTS-STN/digital-dojo-engagement/tree/_dynamic"
    url = "git@github.com:DTS-STN/digital-dojo-engagement.git"
    branch = "refs/heads/main"
...
object Build_Main: BuildType({
    ...
    params {
        ...
        param("env.PROJECT", "digital-dojo-engagement")
    ...
    vcs {
        root(Dev_DigitalDojoEngagement_HttpsGithubComDtsStndigitalDojoEngagementRelease)
    }
...
object Build_Dynamic: BuildType({
    ...
    vcs {
        root(Dev_DigitalDojoEngagement_HttpsGithubComDtsStndigitalDojoEngagementDynamic)
    }
